const Footer = () => {
    ...
    return (
        <footer className="footer bg-[#050505] text-white pt-24 pb-12 font-sans border-t border-white/5 tracking-normal" style={{ backgroundColor: '#050505', paddingTop: '6rem', paddingBottom: '3rem', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
