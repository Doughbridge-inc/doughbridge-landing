    ...
    return (
        <section id="invest" className="section-padding bg-bg-card border-y border-white/5 relative overflow-hidden">
            ...
            <div className="container grid md:grid-cols-2 gap-16 items-center relative z-10">
                <div>
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-primary/20 bg-primary/5 text-primary text-xs font-bold uppercase tracking-wider mb-6" style={{ borderColor: 'rgba(0,255,148,0.2)', backgroundColor: 'rgba(0,255,148,0.05)' }}>
                    ...
                    <div className="mb-6">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                style={{ backgroundColor: 'var(--bg-dark)', border: '1px solid rgba(255,255,255,0.1)' }}
                            />
                        </div>
                    </div>
